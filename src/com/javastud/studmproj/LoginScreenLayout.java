...
public class LoginScreenLayout extends JFrame {
	...
	private JPanel getPanelCenter() {
		if (panelCenter == null) {
			...
			panelCenter.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null,
					null));
			...
			btnSignIn.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						if (!validateSuccess) {
							status.setText("Status: Either Username or Password Invalid!!!");
	...
	private void switchToStudMangScreen() {
		...
		StudentMangement studMngWindow = new StudentMangement(
				username.getText());
